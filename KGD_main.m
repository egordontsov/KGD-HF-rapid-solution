%Rapid approximate solution for plane strain or KGD fracture
%https://link.springer.com/article/10.1007/s10704-017-0192-4
%Egor Dontsov
...
xi = linspace(0,1,Nx)';
[wvst,wvsx,lvst,etavst] = FastKGDSolver(t,xi,Cp,Ep,Kp,mup,Q0/H);

%load vertex solutions
[Wm,Lm,Wmt,Lmt,Wk,Lk,Wkt,Lkt] = KGDVertexSolutions(t,xi,Cp,Ep,Kp,mup,Q0/H);
...
PlotKGDParametricSpace(t,Cp,Ep,Kp,mup,Q0/H);
